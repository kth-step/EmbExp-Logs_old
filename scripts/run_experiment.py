...
exp_runner.run_experiment(args.exp_id, progplat, board_type, args.branchname, args.conn_mode, force_cleanup, args.force_results, args.no_cleanup, True, write_results=not args.no_results)
